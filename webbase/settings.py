...
SECRET_KEY = 'django-insecure--y-t&7nswa=e(r$b7m_@h-fsm$t97giybcir+a8ni2yre2$n27'
...
DATABASES = {
    ...
    "itc_inwhouse": {
        'ENGINE': 'mssql',
        'NAME': os.environ.get('MSSQL_DBNAME'),
        'USER': os.environ.get('MSSQL_USERNAME'),
        'PASSWORD': os.environ.get('MSSQL_PASSWORD'),
        'HOST': os.environ.get('MSSQL_HOSTNAME'),
